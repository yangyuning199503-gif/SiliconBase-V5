...
OUT="$ROOT/reports/research_raw/event_window_robust_latest.txt"
...
"$PY" -m py_compile "$ROOT/tools/event_window_robust.py"
"$PY" -u -m tools.event_window_robust --project-dir . --out "$OUT"
echo "UPLOAD: $OUT"
