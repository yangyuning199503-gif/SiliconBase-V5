...
"$PY" -m tools.stage46_aggressive_lab --project-dir .
...
"$PY" -m tools.stage46_pack_outputs --project-dir .
echo "[OK] stage46 done | outputs: ~/Downloads/deepseek_single_file_latest.txt + ~/Downloads/chatgpt_bundle_latest.zip"
