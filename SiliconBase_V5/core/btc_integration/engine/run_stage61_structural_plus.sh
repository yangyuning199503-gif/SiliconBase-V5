...
"$PY" -m tools.stage59_structural_lab --project-dir .
"$PY" -m tools.stage59_pack_outputs --project-dir . --started-at "$START_EPOCH"

echo "[OK] stage61 refresh done | latest structural bundle written to ~/Downloads"
