...
"$PY" -m tools.stage69_pack_outputs --project-dir . --started-at "$START_EPOCH"

echo "[OK] stage69 done | consolidated bundle refreshed: ~/Downloads/chatgpt_bundle_latest.zip"
