...
trap cleanup EXIT
OUT_DL="$DL/stage107_joint_upgrade_plan_latest.zip"
OUT_ROOT="$ROOT/reports/stage107_joint_upgrade_plan_latest.zip"
...
echo "$OUT_DL" > "$DL/stage107_joint_upgrade_plan_path_latest.txt"
echo "$OUT_ROOT" >> "$DL/stage107_joint_upgrade_plan_path_latest.txt"
echo "$OUT_DL"
