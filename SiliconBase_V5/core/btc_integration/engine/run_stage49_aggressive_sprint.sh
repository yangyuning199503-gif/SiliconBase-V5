...
"$PY" -m tools.stage49_aggressive_sprint_lab --project-dir .
"$PY" -m tools.stage49_pack_outputs --project-dir .
echo "[OK] stage49 done | outputs: ~/Downloads/deepseek_single_file_latest.txt + ~/Downloads/chatgpt_bundle_latest.zip"
