...
"$PY" -m tools.stage73_mainline_bridge_frontier --project-dir .
"$PY" -m tools.stage74_branch_rebuild_lanes --project-dir .
"$PY" -m tools.stage74_pack_outputs --project-dir . --started-at "$START_EPOCH"

echo "[OK] stage73/74 done | bundle refreshed: ~/Downloads/chatgpt_bundle_latest.zip"
