...
"$PY" -m tools.stage63_price_impact_structural_lab --project-dir .
"$PY" -m tools.stage63_pack_outputs --project-dir . --started-at "$START_EPOCH"

echo "[OK] stage63 done | outputs refreshed in ~/Downloads"
