...
bash run_stage59_structural_priority.sh
bash run_stage63_price_impact_structural.sh
bash run_stage64_relevance_hybrid.sh
bash run_stage65_price_impact_frontier.sh
"$PY" -m tools.stage68_pack_outputs --project-dir . --started-at "$START_EPOCH"

echo "[OK] stage68 done | consolidated bundle refreshed: ~/Downloads/chatgpt_bundle_latest.zip"
