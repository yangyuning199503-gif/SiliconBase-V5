...
"$PY" -m tools.stage47_tranche_lock_lab --project-dir .
"$PY" -m tools.stage47_pack_outputs --project-dir .
echo "[OK] stage47 done | outputs: ~/Downloads/deepseek_single_file_latest.txt + ~/Downloads/chatgpt_bundle_latest.zip"
