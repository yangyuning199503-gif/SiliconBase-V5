...
"$PY" -m tools.stage77_mainline_dual_window_lab --project-dir .
"$PY" -m tools.stage78_branch_dual_window_lab --project-dir .
"$PY" -m tools.stage78_pack_outputs --project-dir . --started-at "$START_EPOCH"

echo "[OK] stage77/78 done | bundle refreshed: ~/Downloads/chatgpt_bundle_latest.zip"
