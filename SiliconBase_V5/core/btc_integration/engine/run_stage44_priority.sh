...
"$PY" -m tools.stage44_priority_lab --project-dir .
if [ -f tools/polymarket_probe.py ]; then
...
"$PY" -m tools.stage44_pack_outputs --project-dir .
echo "[OK] stage44 done | outputs: ~/Downloads/deepseek_single_file_latest.txt + ~/Downloads/chatgpt_bundle_latest.zip"
