...
"$PY" -m tools.stage71_mainline_open_bands --project-dir .
"$PY" -m tools.stage72_branch_asymmetry_open --project-dir .
"$PY" -m tools.stage72_pack_outputs --project-dir . --started-at "$START_EPOCH"

echo "[OK] stage71/72 done | bundle refreshed: ~/Downloads/chatgpt_bundle_latest.zip"
