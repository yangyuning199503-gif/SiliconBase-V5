...
"$PY" -m tools.stage54_full_angle --project-dir .
"$PY" -m tools.stage54_pack_outputs --project-dir . --started-at "$START_EPOCH"

echo "[OK] stage54 done | outputs refreshed: ~/Downloads/deepseek_single_file_latest.txt + ~/Downloads/chatgpt_bundle_latest.zip"
