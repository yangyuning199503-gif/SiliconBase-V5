...
OUT="$ROOT/reports/research_raw/message_combo_ab_latest.txt"
...
"$PY" -m py_compile "$ROOT/tools/message_combo_ab_backtest.py"
"$PY" -u -m tools.message_combo_ab_backtest --project-dir . --out "$OUT"
echo "UPLOAD: $OUT"
