...
"$PY" -m tools.stage64_relevance_hybrid_lab --project-dir .
"$PY" -m tools.stage64_polymarket_relevance --project-dir .
"$PY" -m tools.stage64_pack_outputs --project-dir . --started-at "$START_EPOCH"

echo "[OK] stage64 done | outputs refreshed in ~/Downloads"
