...
OUT="$ROOT/reports/research_raw/event_window_sweep_latest.txt"
...
"$PY" -m py_compile "$ROOT/tools/event_window_sweep.py"
"$PY" -u -m tools.event_window_sweep --project-dir . --out "$OUT"
echo "UPLOAD: $OUT"
