...
OUT="$ROOT/reports/research_raw/coinglass_history_export_latest.txt"
...
"$PY" -m py_compile "$ROOT/tools/coinglass_history_export.py"
"$PY" -u "$ROOT/tools/coinglass_history_export.py" --project-dir . --out "$OUT"
echo "UPLOAD: $OUT"
