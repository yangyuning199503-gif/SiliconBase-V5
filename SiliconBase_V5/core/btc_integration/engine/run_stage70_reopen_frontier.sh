...
"$PY" -m tools.stage65_price_impact_frontier_lab --project-dir .
"$PY" -m tools.stage69_branch_single_leg_arena --project-dir .
"$PY" -m tools.stage70_mainline_wide_frontier --project-dir .
"$PY" -m tools.stage70_pack_outputs --project-dir . --started-at "$START_EPOCH"

echo "[OK] stage70 done | bundle refreshed: ~/Downloads/chatgpt_bundle_latest.zip"
